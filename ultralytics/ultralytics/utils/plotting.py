...
class Annotator:
    ...
    def __init__(self, im, line_width=1, font_size=2, font="Arial.ttf", pil=False, example="abc"):
...
def plot_images(
    ...
    ##annotator = Annotator(mosaic, line_width=round(fs / 10), font_size=2, pil=True, example=names)
