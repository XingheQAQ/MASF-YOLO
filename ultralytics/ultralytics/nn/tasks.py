...
from ultralytics.nn.modules.IEMA import EMA, IEMA

from ultralytics.nn.modules.MFAM import MFAM

from ultralytics.nn.modules.DASI import DASI
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        #print(f"Layer: {m}, Arguments: {args}")
